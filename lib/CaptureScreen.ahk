...
class CaptureScreen {
	...
	If bCursor
		This.CaptureCursor(mDC, nL, nT)
	DllCall("SelectObject", "ptr", mDC, "ptr", oBM)
	DllCall("DeleteDC", "ptr", mDC)
	If znW && znH
		hBM := This.Zoomer(hBM, nW, nH, znW, znH)
	If sFile = 0
		This.SetClipboardData(hBM)
	Else This.Convert(hBM, sFile, nQuality), DllCall("DeleteObject", "ptr", hBM)
}
...
Zoomer(hBM, nW, nH, znW, znH)
{
	...
	zhBM := This.CreateDIBSection(mDC2, znW, znH)
...
Convert(sFileFr = "", sFileTo = "", nQuality = "")
{
	...
	If Not hGdiPlus := DllCall("LoadLibrary", "str", "gdiplus.dll", "ptr")
		Return	sFileFr+0 ? This.SaveHBITMAPToFile(sFileFr, sDirTo (sDirTo = "" ? "" : "\") sNameTo ".bmp") : ""
	...
	If pImage
		pCodec < &ci + nSize	? DllCall("gdiplus\GdipSaveImageToFile", "ptr", pImage, "wstr", sFileTo, "ptr", pCodec, "ptr", pParam) : DllCall("gdiplus\GdipCreateHBITMAPFromBitmap", "ptr", pImage, "ptr*", hBitmap, "Uint", 0) . This.SetClipboardData(hBitmap), DllCall("gdiplus\GdipDisposeImage", "ptr", pImage)
